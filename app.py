...
def recommend():
    ...
    if len(suggestions) == 0:
        return render_template('recommend.html', data=[], title=f'No suggestions found for "{user_input}".', book_title="")
    else:
        return render_template('recommend.html', data=suggestions[1:], title="Top 5 recommendations for ", book_title=str(user_input))
